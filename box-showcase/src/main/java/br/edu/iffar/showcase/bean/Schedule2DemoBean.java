...
/**
 * Estado da página de demonstração do b:schedule2 (/schedule2.xhtml) -
 * mesma estrutura do ScheduleDemoBean (b:schedule), instância separada
 * pra não misturar estado entre as duas páginas de comparação.
 */
@Named
@SessionScoped
public class Schedule2DemoBean implements Serializable {
    ...
    public void aoSelecionar(AjaxBehaviorEvent evento) {
        Schedule2 schedule = (Schedule2) evento.getComponent();
